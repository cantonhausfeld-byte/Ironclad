...
class Settings(BaseSettings):
    ...
    @property
    def ODDSAPI__KEY(self) -> str | None:  # pragma: no cover - compatibility alias
        return self.oddsapi_key

    @property
    def SPORTSGAMEODDS__KEY(self) -> str | None:  # pragma: no cover - compatibility alias
        return self.sgo_key

    @property
    def WEATHER__KEY(self) -> str | None:  # pragma: no cover - compatibility alias
